...
public class MUser extends JFrame{
    JLabel login, nomec, email, senha, senhar, rotulo;
     ...
     Container tela = getContentPane(); 
        ...
        nomec.setForeground(Color.black);
        email.setForeground(Color.black);
        senha.setForeground(Color.black);
        senhar.setForeground(Color.black);
        ...
        limpar.setForeground(Color.black);
            ...
            cad.setBounds(20,220,130,30);
            fechar.setBounds(420,220,120,30);
            limpar.setBounds(220,220,120,30);
        ...
        public void actionPerformed(ActionEvent e){
         ...
         JDesktopPane desk = new JDesktopPane(){
          Image im = (new ImageIcon("mn.png")).getImage(); 
        ...
        JLabel status = new JLabel();
            ...
            status.setIcon(new ImageIcon("mn.png"));
            tela.add(status);
