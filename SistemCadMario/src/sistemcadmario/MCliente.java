 ...
 * @author italo
 */
public class MCliente extends JFrame{
    JLabel rotulo1, rotulo2, rotulo3, rotulo4, rotulo5, rotulo6, rotulo7, rotulo8;
     ...
     Container tela = getContentPane(); 
        ...
        icone = new ImageIcon("ma.png");
        icon2 = new ImageIcon("star.png");
        icon3 = new ImageIcon("bala.png");
...
try{        
	...
	mascaracpf.setPlaceholderCharacter('_');
        ...
        mascaracep.setPlaceholderCharacter('_');
            ...
            rotulo8.setForeground(Color.black);
            ...
            button1.setBounds(20,300,130,30);
            button2.setBounds(420,300,120,30);
            limp.setBounds(220,300,120,30);
