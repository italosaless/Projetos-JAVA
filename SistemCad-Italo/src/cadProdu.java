 ...
 * @author italo
 */
public class cadProdu extends JFrame{
    ...
    public cadProdu() throws ParseException{
     ...
     Container tela = getContentPane(); 
        ...
        icone2 = new ImageIcon("Limp3.gif");
        limp = new JButton("Limpar",icone2);
        icone3 = new ImageIcon("Close3.gif");
        fech = new JButton("Fechar",icone3);
        add = new JButton("ADD FOTO: ");
        ...
        codeb = new JFormattedTextField(mascarab);
          ...
          descprod.setBounds(50,210,200,20);
           ...
           vlma.setBounds(620,460,100,20);
            ...
            cad.setBounds(50,520,120,20);
            limp.setBounds(320,520,120,20);
            fech.setBounds(600,520,120,20);
            add.setBounds(650,100,100,20);
